...
<CardGroup cols={2}>
  ...
  <Card title="Use lnav for Analysis" icon="magnifying-glass">
    Use lnav to interactively explore logs with SQL queries and regex filtering before sharing with an agent.
